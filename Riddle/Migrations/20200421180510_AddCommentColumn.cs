        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiddlePostId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainComments_RiddlePosts_RiddlePostId",
                        column: x => x.RiddlePostId,
                        principalTable: "RiddlePosts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainComments_RiddlePostId",
                table: "MainComments",
                column: "RiddlePostId");
